...
import { ConvertPDF } from '../../wailsjs/go/main/App'
...
.btn{flex:1;padding:10px 16px;border:none;border-radius:6px;font-size:14px;font-weight:600;cursor:pointer;transition:.15s}
